...
test_that("[CFA 3-Factor] Factor loadings table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.741164020131046, 1.05807660760393, 0.899620313867488, "<unicode>11",
                                      "Factor 1", 0, "x1", 0.0808465333987386, 11.1275063512065, 0.346131928251774,
                                      0.649749093967046, 0.49794051110941, "<unicode>12", "Factor 1",
                                      1.28623778294923e-10, "x2", 0.0774547818506273, 6.42878979466621,
                                      0.510293170576109, 0.802019014680793, 0.656156092628451, "<unicode>13",
                                      "Factor 1", 0, "x3", 0.0744212256974568, 8.81678696472846, 0.878687521771487,
                                      1.1006993764173, 0.989693449094392, "<unicode>21", "Factor 2",
                                      0, "x4", 0.0566367179185465, 17.4744138690689, 0.978762425338572,
                                      1.22444687472433, 1.10160465003145, "<unicode>22", "Factor 2",
                                      0, "x5", 0.0626757561168699, 17.5762482701815, 0.811432261987188,
                                      1.02176969353156, 0.916600977759373, "<unicode>23", "Factor 2",
                                      0, "x6", 0.0536584940344529, 17.0821226769958, 0.483096088879333,
                                      0.75585477823652, 0.619475433557926, "<unicode>31", "Factor 3",
                                      0, "x7", 0.0695825769015842, 8.90273774186456, 0.601768916407813,
                                      0.860128689422337, 0.730948802915075, "<unicode>32", "Factor 3",
                                      0, "x8", 0.0659093164600047, 11.0902197469857, 0.54254918241612,
                                      0.797411035146398, 0.669980108781259, "<unicode>33", "Factor 3",
...
test_that("[CFA Second order] Factor loadings table results match", {
  table <- results[["results"]][["estimates"]][["collection"]][["estimates_fl1"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(0.0577039904414908, 0.819337251278242, 0.438520620859867, "<unicode>11",
                                      "Factor 1", 0.0240111123688183, "x1", 0.194297769460158, 2.25695139001474,
                                      0.0315641080012427, 0.453878987089273, 0.242721547545258, "<unicode>12",
                                      "Factor 1", 0.0242627980684818, "x2", 0.107735367185111, 2.25294212928438,
                                      0.0503061064249717, 0.589382650102084, 0.319844378263528, "<unicode>13",
                                      "Factor 1", 0.0200309356495567, "x3", 0.137522053448247, 2.32576790590095,
                                      0.71768085442071, 0.966830831063184, 0.842255842741947, "<unicode>21",
                                      "Factor 2", 0, "x4", 0.0635598354377267, 13.2513848870354, 0.799268757944165,
                                      1.07572151104007, 0.937495134492118, "<unicode>22", "Factor 2",
                                      0, "x5", 0.0705249574167, 13.2930974910468, 0.663204523777401,
                                      0.896899759208491, 0.780052141492946, "<unicode>23", "Factor 2",
                                      0, "x6", 0.0596172269680586, 13.0843412410121, 0.392491072303089,
                                      0.651164920657023, 0.521827996480056, "<unicode>31", "Factor 3",
                                      2.66453525910038e-15, "x7", 0.0659894391923322, 7.90775013194371,
                                      0.483529756039699, 0.747933394180798, 0.615731575110249, "<unicode>32",
                                      "Factor 3", 0, "x8", 0.0674511471197128, 9.12855602021777, 0.438789772679437,
                                      0.689958088778821, 0.564373930729129, "<unicode>33", "Factor 3",
...
test_that("[CFA Second order] Second-order factor loadings table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(-0.14910405407519, 3.73161619230762, 1.79125606911621, "<unicode>11",
                                      ...
                                      "<unicode>12", "SecondOrder", 1.6021965671964e-06, "Factor 2",
                                      0.128602970800593, 4.79804766430388, 0.360410276598517, 0.919053360468363,
                                      0.63973181853344, "<unicode>13", "SecondOrder", 7.15860527811252e-06,
...
test_that("Bootstrapping works", {
  ...
  table <- results[["results"]][["estimates"]][["collection"]][["estimates_fl1"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(0.712022271311838, 1.11279383173753, 0.899620313867488, "<unicode>11",
                                      "Factor 1", 0, "x1", 0.0808465333987386, 11.1275063512065, 0.339182433474584,
                                      0.693156723678194, 0.49794051110941, "<unicode>12", "Factor 1",
                                      1.28623778294923e-10, "x2", 0.0774547818506273, 6.42878979466621,
                                      0.539990088382033, 0.805660643384033, 0.656156092628451, "<unicode>13",
                                      "Factor 1", 0, "x3", 0.0744212256974568, 8.81678696472846, 0.856032790026098,
                                      1.08543684864592, 0.989693449094392, "<unicode>21", "Factor 2",
                                      0, "x4", 0.0566367179185465, 17.4744138690689, 0.954112872546464,
                                      1.24054019999221, 1.10160465003145, "<unicode>22", "Factor 2",
                                      0, "x5", 0.0626757561168699, 17.5762482701815, 0.803928010900409,
                                      1.03630968014001, 0.916600977759373, "<unicode>23", "Factor 2",
                                      0, "x6", 0.0536584940344529, 17.0821226769958, 0.375767927218761,
                                      0.741040160352204, 0.619475433557926, "<unicode>31", "Factor 3",
                                      0, "x7", 0.0695825769015842, 8.90273774186456, 0.506218568773711,
                                      0.900974372672674, 0.730948802915075, "<unicode>32", "Factor 3",
                                      0, "x8", 0.0659093164600047, 11.0902197469857, 0.498364732719689,
                                      0.860170344673322, 0.669980108781259, "<unicode>33", "Factor 3",
                                      0, "x9", 0.0650169734598685, 10.3046954222623))
...
test_that("Thresholds table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(-1.37345271503234, -1.05964335802485, -1.2165480365286, "V1",
                                      0, "t1", 0.0800548784270476, -15.1964260071572, -0.358874219848855,
                                      -0.118911115849374, -0.238892667849114, "V1", 9.52271353014122e-05,
                                      "t2", 0.0612162024129726, -3.90244181168758, 0.124863894782197,
                                      0.364954328270292, 0.244909111526244, "V1", 6.3717733790325e-05,
                                      "t3", 0.0612486850222499, 3.99860195263418, 0.547166075781201,
                                      0.805483371744301, 0.676324723762751, "V5", 0, "t1", 0.065898480278381,
                                      10.2631308173677, 1.32801878330997, 1.69596338637514, 1.51199108484256,
                                      "V5", 0, "t2", 0.0938651439433244, 16.1081208777083, 1.58695081056115,
                                      2.03777591515951, 1.81236336286033, "V5", 0, "t3", 0.115008517542776,
                                      15.7585142525312, -0.667907099127094, -0.417271559864424, -0.542589329495759,
                                      "V8", 0, "t1", 0.0639388124576908, -8.48607142734779, 0.575854076158956,
                                      0.836151253707481, 0.706002664933219, "V8", 0, "t2", 0.0664035613923819,
                                      10.6320000031537, 1.28086251788209, 1.63744971087504, 1.45915611437857,
                                      "V8", 0, "t3", 0.090967792215996, 16.040359767267))
})

test_that("Thresholds table results match", {
  table <- results[["results"]][["estimates"]][["collection"]][["estimates_m"]][["collection"]][["estimates_m_Thresholds"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(-1.33296389680349, -1.01400542884757, -1.17348466282553, "V1",
                                      0, "t1", 0.0813684512755931, -14.4218630738216, -0.342662717731549,
                                      -0.0942651168100136, -0.218463917270781, "V1", 0.000565698466995501,
                                      "t2", 0.0633678993289836, -3.44754867344733, 0.276480375367169,
                                      0.53014885331, 0.403314614338585, "V1", 4.59333238111981e-10,
                                      "t3", 0.0647125355220137, 6.23240321346065, 0.501097035494698,
                                      0.766182966064704, 0.633640000779701, "V5", 0, "t1", 0.067625204509106,
                                      9.36987925403433, 1.35781354298621, 1.74921140203548, 1.55351247251084,
                                      "V5", 0, "t2", 0.0998482273492178, 15.5587386351633, 1.60472242820073,
                                      2.08355527282974, 1.84413885051524, "V5", 0, "t3", 0.122153480473616,
                                      15.0968997638471, -0.629660973554337, -0.371855294149489, -0.500758133851913,
                                      "V8", 2.66453525910038e-14, "t1", 0.0657679634519783, -7.61401307822997,
                                      0.682580238630726, 0.961593110504241, 0.822086674567484, "V8",
                                      0, "t2", 0.0711780609425307, 11.549720007563, 1.45747588382256,
                                      1.8793065040716, 1.66839119394708, "V8", 0, "t3", 0.107611829496968,
                                      15.5037898876544))
})

...
test_that("Factor Covariances table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.303559889075027, 0.587606030591397, 0.45850979948829, "Factor 1",
                                      "<unicode>", 2.18336460022783e-12, "Factor 2", 0.0652939904008311,
                                      7.02223583937142, 0.252421930436749, 0.673386393756763, 0.47053468289697,
                                      "Factor 1", "<unicode>", 4.46542086729451e-06, "Factor 3", 0.102547557533165,
                                      4.58845334024453, 0.121288847658376, 0.477047659983088, 0.282985557346168,
                                      "Factor 2", "<unicode>", 0.00243831910092385, "Factor 3", 0.0933670666183133,
                                      3.03089266478746))
})
...
test_that("Factor loadings table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.609016736694521, 0.947944173784, 0.771880719099138, "Factor 1",
                                      0, "x1", 0.0786115510218265, 9.81892239837406, 0.299796801762151,
                                      0.562461136330549, 0.423601841658074, "Factor 1", 7.14495129727766e-11,
                                      "x2", 0.064993705156209, 6.51758259726798, 0.476555121784312,
                                      0.705409627843936, 0.58113226322415, "Factor 1", 0, "x3", 0.0595305692570535,
                                      9.76191342492992, 0.794492625635462, 0.889617457497235, 0.851582471792654,
                                      "Factor 2", 0, "x4", 0.0252287552999648, 33.7544386025989, 0.802409345594677,
                                      0.90040015692512, 0.855065680704751, "Factor 2", 0, "x5", 0.0224201308613519,
                                      38.138300172847, 0.793490380780966, 0.881881451570573, 0.838010342686877,
                                      "Factor 2", 0, "x6", 0.0218438405416351, 38.3636907204848, 0.35763220913514,
                                      0.655842503009954, 0.569516154199535, "Factor 3", 1.55209178842597e-13,
                                      "x7", 0.0771428718561286, 7.38261540562921, 0.522578395793627,
                                      0.878644171701047, 0.723044461474298, "Factor 3", 2.22044604925031e-16,
                                      "x8", 0.0880537536521129, 8.21139850926671, 0.519839886395977,
                                      0.85813230709943, 0.665009552630709, "Factor 3", 4.10782519111308e-14,
                                      "x9", 0.0879930999118908, 7.55751932022619))
})
...
test_that("Residual variances table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.101393039850757, 0.629083214539259, 0.404200155482997, "x1",
                                      0.00100273550594765, 0.122866224371867, 3.28975808892478, 0.68358907561605,
                                      0.909953553900775, 0.820561479743888, "x2", 0, 0.056156748632399,
                                      14.6119834165484, 0.502389550531345, 0.772878535132245, 0.662285292639977,
                                      "x3", 0, 0.0705519016946706, 9.38720681840961, 0.208580150389682,
                                      0.368768950437494, 0.274807293735513, "x4", 9.8972385842444e-11,
                                      0.042483846193897, 6.46851258431941, 0.189276073717449, 0.356138010656408,
                                      0.268862681680922, "x5", 2.271738352988e-12, 0.0383175440648924,
                                      7.01669922335292, 0.222258834237173, 0.370371227914033, 0.297738665549823,
                                      "x6", 4.44089209850063e-16, 0.0366330175803747, 8.12760414553807,
                                      0.569870176391053, 0.872077590620781, 0.675651350105771, "x7",
                                      0, 0.0781557946460347, 8.6449296967138, 0.227882271960117, 0.726900296883314,
                                      0.477206706731343, "x8", 9.12901071781214e-05, 0.121965197212693,
                                      3.91264653882494, 0.263606923380453, 0.729486818565604, 0.557762294909905,
                                      "x9", 4.11975866088099e-06, 0.121114513809274, 4.60524735943908
                                 ))
})
...
test_that("Factor Intercepts table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0, 0, 0, "Pasteur", "Factor 1", "", 0, "", 0, 0, 0, "Pasteur",
                                      ...
                                      "Grant-White", "Factor 1", 0.330401504387184, 0.180349637075431,
                                      -0.973305470516696, 0.368728529275798, 0.871679864930804, 0.617893927834581,
                                      "Grant-White", "Factor 2", 0.000000264246255543554, 0.12004206899666,
                                      5.14731154668597, -0.540348169119783, 0.0413253948002106, -0.24956546627844,
                                      "Grant-White", "Factor 3", 0.063683858461582, 0.134581135854936,
                                      -1.85438668423371))
})
...
test_that("Intercepts table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(3.65022119771387, 5.13027905453576, 4.30190068090687, "Pasteur",
                                      "x1", 0, 0.311792543987848, 13.7973173632867, 4.51213484792976,
                                      5.57641858113713, 4.92467499942217, "Pasteur", "x2", 0, 0.276009481941517,
                                      17.8424123866355, 1.65475923878407, 2.14145250475774, 1.88486022383063,
                                      "Pasteur", "x3", 0, 0.113778480343633, 16.5660520173761, 2.17645346601327,
                                      2.71826792801374, 2.41343151699624, "Pasteur", "x4", 0, 0.120329021476608,
                                      20.0569362850292, 2.91536922473356, 3.50053485639102, 3.18431283764559,
                                      "Pasteur", "x5", 0, 0.150058972672264, 21.220409422636, 1.66606132251122,
                                      2.18009490954565, 1.90007550339723, "Pasteur", "x6", 0, 0.129891091004889,
                                      14.6282203706005, 3.53904916830473, 4.39807370417912, 3.8553172018654,
                                      "Pasteur", "x7", 0, 0.202444060458234, 19.0438642316245, 5.28428050429713,
                                      6.43438719831971, 5.77059511069387, "Pasteur", "x8", 0, 0.293609751410138,
                                      19.6539627276651, 4.96240921194386, 6.30893973296942, 5.51562543184978,
                                      "Pasteur", "x9", 0, 0.37300576810248, 14.7869708822691, 3.82416895442114,
                                      4.99494592985408, 4.2859787708933, "Grant-White", "x1", 0, 0.277910374037392,
                                      15.422161859696, 5.00712888597332, 6.43491783003054, 5.61810087972815,
                                      "Grant-White", "x2", 0, 0.375551067621402, 14.9596189815438,
                                      1.96258393784137, 2.46601013644339, 2.17351742478477, "Grant-White",
                                      "x3", 0, 0.114834075100045, 18.9274605372244, 2.25119636373155,
                                      2.90779977569276, 2.52203984502696, "Grant-White", "x4", 0,
                                      0.16434728096712, 15.3457959887485, 2.90965221277875, 3.88386369417219,
                                      3.33046740971937, "Grant-White", "x5", 0, 0.23158964757374,
                                      14.3808993390299, 1.52934256431605, 2.04296262254005, 1.76312404048121,
                                      "Grant-White", "x6", 0, 0.11250372579262, 15.6716946755274,
                                      3.62828552274827, 4.57062514267745, 3.99057053716559, "Grant-White",
                                      "x7", 0, 0.212235023934773, 18.8026013010559, 4.63346894913212,
                                      6.46856356795117, 5.42204277713541, "Grant-White", "x8", 0,
                                      0.486951664902976, 11.1346631871887, 4.87060940044105, 6.18142023416206,
                                      5.36856945405648, "Grant-White", "x9", 0, 0.34210370421571,
                                      15.692812991792))
})
...
test_that("Factor Covariances table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.228183160189731, 0.660825935297529, 0.489651501809208, "Pasteur",
                                      "Factor 1", "<unicode>", 0.00000819752512914995, "Factor 2",
                                      0.109788336228116, 4.45995921453642, -0.00807731853350358, 0.62870849408938,
                                      0.351445137103768, "Pasteur", "Factor 1", "<unicode>", 0.0219364852411905,
                                      "Factor 3", 0.153371318296477, 2.29146584255344, 0.0952853606061416,
                                      0.544228582805629, 0.338229765920924, "Pasteur", "Factor 2",
                                      "<unicode>", 0.00170394222183923, "Factor 3", 0.107802253647914,
                                      3.13750180980069, 0.358139248371121, 0.743531664104939, 0.543999435723382,
                                      "Grant-White", "Factor 1", "<unicode>", 0.000000027219348552876,
                                      "Factor 2", 0.0978690508214361, 5.55844192987954, 0.252394618569737,
                                      0.807604894697997, 0.549563676512851, "Grant-White", "Factor 1",
                                      "<unicode>", 0.0000366696367706254, "Factor 3", 0.133146214068315,
                                      4.12752011282032, 0.0171525783585205, 0.572598744831089, 0.356206518510521,
                                      "Grant-White", "Factor 2", "<unicode>", 0.00450906165786469,
                                      "Factor 3", 0.125417672561523, 2.84016208589572))
})
...
test_that("Factor loadings table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.497946043151746, 0.928399346761365, 0.767504218747721, "Pasteur",
                                      "Factor 1", 0.0000000000000475175454539567, "x1", 0.101811262632927,
                                      7.53850015115615, 0.267970168041768, 0.532671928457776, 0.411240885120536,
                                      "Pasteur", "Factor 1", 0.0000000000392255117276363, "x2", 0.0622434561090968,
                                      6.60697382227195, 0.477533480398189, 0.782692612333735, 0.591249578075409,
                                      "Pasteur", "Factor 1", 0.00000000000000111022302462516, "x3",
                                      0.073750423333493, 8.0168974136166, 0.747908871607011, 0.88042427857654,
                                      0.8147367537784, "Pasteur", "Factor 2", 0, "x4", 0.0362231137893279,
                                      22.4921788479277, 0.748735883515215, 0.900200523748822, 0.828893981424851,
                                      "Pasteur", "Factor 2", 0, "x5", 0.0351786459480662, 23.5624185947502,
                                      0.819929930935631, 0.911328306235974, 0.862398357717919, "Pasteur",
                                      "Factor 2", 0, "x6", 0.026561624486056, 32.4678318591038, 0.295709313671858,
                                      0.669807670173096, 0.516017953908184, "Pasteur", "Factor 3",
                                      0.000000000681297240845424, "x7", 0.0836283448372578, 6.17037148005696,
                                      0.41441662557669, 0.789023866054136, 0.657296908755646, "Pasteur",
                                      "Factor 3", 0, "x8", 0.075970178451242, 8.652038499258, 0.394912547811197,
                                      0.78277912111732, 0.578220175361584, "Pasteur", "Factor 3",
                                      0.000000000765282059944639, "x9", 0.0939894920759243, 6.15196616760627,
                                      0.522511070107775, 0.846618448456704, 0.721069217728034, "Grant-White",
                                      "Factor 1", 0, "x1", 0.0758123550978674, 9.51123621996961, 0.28009909049072,
                                      0.591288754791562, 0.442399667834903, "Grant-White", "Factor 1",
                                      0.0000000596421201315422, "x2", 0.0816255005854338, 5.41987080828819,
                                      0.4665689170855, 0.839057811516596, 0.642926562525478, "Grant-White",
                                      "Factor 1", 0.00000000000541899858319539, "x3", 0.0932569147018174,
                                      6.89414360941697, 0.769343771364018, 0.906232144313084, 0.846861013649664,
                                      "Grant-White", "Factor 2", 0, "x4", 0.0336025590768953, 25.2022773536899,
                                      0.803522481668752, 0.910290086939244, 0.862315742630346, "Grant-White",
                                      "Factor 2", 0, "x5", 0.0259003251037486, 33.2936262064735, 0.702293669144307,
                                      0.862016225028908, 0.795972011539709, "Grant-White", "Factor 2",
                                      0, "x6", 0.039441601865225, 20.1810264770586, 0.409687044545161,
                                      0.769910018211471, 0.668495625055567, "Grant-White", "Factor 3",
                                      0.0000000000000603961325396085, "x7", 0.0890489946320087, 7.50705415393063,
                                      0.510868083398289, 0.89960164853536, 0.772970300051754, "Grant-White",
                                      "Factor 3", 0, "x8", 0.090545450037889, 8.53682100788391, 0.535526874409041,
                                      0.894743651691221, 0.704394462211568, "Grant-White", "Factor 3",
                                      0.00000000000000133226762955019, "x9", 0.0882362962833766, 7.98304656792664
                                 ))
})
...
test_that("Residual variances table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.13769385285961, 0.751963603543048, 0.410937274204451, "Pasteur",
                                      "x1", 0.00594661222873993, 0.149393123641241, 2.75071077027141,
                                      0.715838940853543, 0.928176318373662, 0.830880934405278, "Pasteur",
                                      "x2", 0, 0.0505828555905754, 16.4261373681736, 0.387346843044124,
                                      0.77194706346048, 0.650423936425651, "Pasteur", "x3", 0.000000000000993649607039515,
                                      0.0912059675362372, 7.1313747772834, 0.224838657858211, 0.440627011382283,
                                      0.336204022042635, "Pasteur", "x4", 0.0000000110444358103479,
                                      0.0588401268895581, 5.7138561695097, 0.189627716613645, 0.439392033305594,
                                      0.312934767557658, "Pasteur", "x5", 0.0000000673556610486514,
                                      0.0579714328056622, 5.39808578833492, 0.169480327190342, 0.327708010982767,
                                      0.256269072605437, "Pasteur", "x6", 0.0000000223473901606042,
                                      0.0458214846757022, 5.59277104221219, 0.55072074264655, 0.912552855627813,
                                      0.733725471244411, "Pasteur", "x7", 0, 0.0818837553149231, 8.9605742729131,
                                      0.377441220237523, 0.828237434236209, 0.567960773740272, "Pasteur",
                                      "x8", 0.00000000303441116678016, 0.0957819636999178, 5.92972572080143,
                                      0.385800919788681, 0.844031974744684, 0.665661428804819, "Pasteur",
                                      "x9", 0.0000000196017337916743, 0.118540432794059, 5.61547999374424,
                                      0.283237160581203, 0.726969266177735, 0.480059183245081, "Grant-White",
                                      "x1", 0.00000553752370446858, 0.105662652359257, 4.54331944661831,
                                      0.650154588485026, 0.921542190895353, 0.804282533899567, "Grant-White",
                                      "x2", 0, 0.073683399077588, 10.915383165924, 0.295953825721606,
                                      0.782292724286878, 0.586645435199173, "Grant-White", "x3", 0.00000134298326526228,
                                      0.121376132092695, 4.83328497196757, 0.178735758175973, 0.40810567705553,
                                      0.282826423560263, "Grant-White", "x4", 0.00000054720079889492,
                                      0.0564639081634826, 5.00897711050008, 0.171357013106635, 0.354346710932066,
                                      0.256411560011874, "Grant-White", "x5", 0.00000000859926330143423,
                                      0.0445447389928761, 5.75627034323585, 0.256913974946414, 0.506749624900821,
                                      0.36642855684543, "Grant-White", "x6", 0.00000000383876308518438,
                                      0.0622014674453743, 5.89099537188941, 0.407230036006067, 0.831704529042534,
                                      0.553113599281567, "Grant-White", "x7", 0.0000000910947375309945,
                                      0.103508627750483, 5.34364730073416, 0.190641593332729, 0.734397244925674,
                                      0.402516915237902, "Grant-White", "x8", 0.00165746025448477,
                                      0.127961852500887, 3.14560087534768, 0.197649385554837, 0.713208259471529,
                                      0.503828441605676, "Grant-White", "x9", 0.0000601691161026263,
                                      0.125575780995648, 4.01214659077562))
})

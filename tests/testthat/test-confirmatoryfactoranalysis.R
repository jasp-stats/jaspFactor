...
test_that("Factor Covariances table results match", {
  table <- results[["results"]][["estimates"]][["collection"]][["estimates_fc"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(0.252069643751425, 0.564393435959575, 0.4082315398555, 1, "Factor 1",
                                      "<unicode>", 2.99674828285745e-07, "Factor 2", 0.0796759008511687,
                                      5.12365138635909, 0.153674632748802, 0.370774902932515, 0.262224767840658,
                                      1, "Factor 1", "<unicode>", 2.1939154322137e-06, "Factor 3",
                                      0.0553837396748543, 4.73468872597123, 0.0768417287748731, 0.270147907288013,
                                      0.173494818031443, 1, "Factor 2", "<unicode>", 0.000434506858657757,
                                      "Factor 3", 0.0493137067920418, 3.51818651076219, 0.252069643751426,
                                      0.564393435959575, 0.4082315398555, 2, "Factor 1", "<unicode>",
                                      2.99674828285745e-07, "Factor 2", 0.0796759008511687, 5.1236513863591,
                                      0.153674632748802, 0.370774902932515, 0.262224767840658, 2,
                                      "Factor 1", "<unicode>", 2.1939154322137e-06, "Factor 3", 0.0553837396748543,
                                      4.73468872597123, 0.0768417287748731, 0.270147907288013, 0.173494818031443,
                                      2, "Factor 2", "<unicode>", 0.000434506858657757, "Factor 3",
                                      0.0493137067920418, 3.51818651076219))
})

test_that("Factor variances table results match", {
  table <- results[["results"]][["estimates"]][["collection"]][["estimates_fv"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(0.51579922628888, 1.10282884918973, 0.809314037739304, 1, "Factor 1",
                                      6.50814258040811e-08, 0.149755206608709, 5.40424641030303, 0.759562812574203,
                                      1.19941902306092, 0.97949091781756, 1, "Factor 2", 0, 0.112210278851102,
                                      8.7290658917023, 0.203306550279352, 0.564190199988996, 0.383748375134174,
                                      1, "Factor 3", 3.06899737032573e-05, 0.0920638472329718, 4.16828523538758,
                                      0.51579922628888, 1.10282884918973, 0.809314037739304, 2, "Factor 1",
                                      6.50814258040811e-08, 0.149755206608709, 5.40424641030303, 0.759562812574203,
                                      1.19941902306092, 0.97949091781756, 2, "Factor 2", 0, 0.112210278851102,
                                      8.72906589170229, 0.203306550279352, 0.564190199988996, 0.383748375134174,
                                      2, "Factor 3", 3.06899737032573e-05, 0.0920638472329717, 4.16828523538759
                                 ))
})
...
test_that("Factor Intercepts table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(4.86032703729577, 5.21479167387077, 5.03755935558327, 1, "Factor 1",
                                      0, 0.090426313792235, 55.7089982364829, 2.75710153479434, 3.10340246097582,
                                      2.93025199788508, 1, "Factor 2", 0, 0.088343696341633, 33.1687728635842,
                                      3.90410200426111, 4.22060103316011, 4.06235151871061, 1, "Factor 3",
                                      0, 0.0807410318239286, 50.3133465964288, 4.68082259954853, 5.03876634316866,
                                      4.85979447135859, 2, "Factor 1", 0, 0.0913138574084872, 53.2207773199043,
                                      3.03093169693174, 3.3907128242691, 3.21082226060042, 2, "Factor 2",
                                      0, 0.0917825863575222, 34.9829132957014, 4.13415749314571, 4.48968795507957,
                                      4.31192272411264, 2, "Factor 3", 0, 0.0906982130126474, 47.5414297689786
                                 ))
})
...
test_that("Factor Intercepts table results match", {
  table <- results[["results"]][["estimates"]][["collection"]][["estimates_Factor Intercepts"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(3.65754400738779, 7.85746191244071, 5.75750295991425, 1, "Factor 1",
                                      7.71475485716877e-08, 1.0714273165684, 5.37367572291749, 2.67329743888011,
                                      3.38328888769281, 3.02829316328646, 1, "Factor 2", 0, 0.181123595742837,
                                      16.7194845644854, 3.71374413938686, 5.75309790047635, 4.7334210199316,
                                      1, "Factor 3", 0, 0.520252866168884, 9.09830839527763, 4.96696097397706,
                                      7.02507093096112, 5.99601595246909, 2, "Factor 1", 0, 0.525037697941945,
                                      11.4201627349282, 2.92991249413903, 3.60159845584644, 3.26575547499273,
                                      2, "Factor 2", 0, 0.171351608245249, 19.058796753857, 2.793007701454,
                                      5.28401148493782, 4.03850959319591, 2, "Factor 3", 2.08242978416706e-10,
                                      0.635471825791837, 6.35513555327757))
})

test_that("Intercepts table results match", {
  table <- results[["results"]][["estimates"]][["collection"]][["estimates_Intercepts"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(-2.82086049306897, 1.37206410197526, -0.724398195546852, 1, "x1",
                                      0.498257853951389, 1.06964327613096, -0.677233440074615, 1.6579921814542,
                                      4.92350462308137, 3.29074840226779, 1, "x2", 7.80789775793878e-05,
                                      0.833054195736533, 3.95022126904759, -3.9895831284748, -1.14311728496707,
                                      -2.56635020672093, 1, "x3", 0.000409050402817135, 0.726152589017015,
                                      -3.53417483534002, -0.437370677504958, 0.216400318827097, -0.110485179338931,
                                      1, "x4", 0.507679587603854, 0.166781380037826, -0.662455121272365,
                                      0.417590399459313, 1.09105191834536, 0.754321158902338, 1, "x5",
                                      1.13050308931939e-05, 0.17180456482829, 4.39057693057366, -0.968470973968885,
                                      -0.319200985157928, -0.643835979563407, 1, "x6", 0.000101440416994558,
                                      0.165633142734335, -3.88712046957944, -1.69451524371202, 0.339644579320786,
                                      -0.677435332195615, 1, "x7", 0.191739032345593, 0.518927857623404,
                                      -1.30545185085678, -2.84093538587357, -0.0293351814438569, -1.43513528365872,
                                      1, "x8", 0.0454071513513012, 0.717258129896075, -2.00086304196601,
                                      1.05054048576094, 3.17460074594772, 2.11257061585433, 1, "x9",
                                      9.67009333712188e-05, 0.541862064033088, 3.89872396700082, -2.16953548981766,
                                      -0.134323505968075, -1.15192949789287, 2, "x1", 0.0265086185992982,
                                      0.51919627092719, -2.21867829642869, 1.74677342548164, 3.48493867238887,
                                      2.61585604893525, 2, "x2", 3.65035446314721e-09, 0.443417649665415,
                                      5.89930520562065, -2.34974383123603, -0.578109270848743, -1.46392655104239,
                                      2, "x3", 0.00119911054203281, 0.451955896731194, -3.23909160524368,
                                      -0.36798865865047, 0.227876404599755, -0.0700561270253575, 2,
                                      "x4", 0.64489351397835, 0.152009186890762, -0.460867717657759,
                                      0.592141420248959, 1.21531497293793, 0.903728196593445, 2, "x5",
                                      1.31048960572144e-08, 0.158975766290729, 5.68469155821359, -1.12184965654026,
                                      -0.545494482595909, -0.833672069568086, 2, "x6", 1.4279661453287e-08,
                                      0.14703208285728, -5.67000108661529, -0.977643544907075, 1.51717429862637,
                                      0.269765376859647, 2, "x7", 0.671665767304788, 0.636444818173255,
                                      0.423862947983357, 0.174180036260091, 2.10442292951146, 1.13930148288577,
                                      2, "x8", 0.0206848446354611, 0.492417949635013, 2.31368796310175,
                                      -2.8898649408433, 0.071731221352461, -1.40906685974542, 2, "x9",
                                      0.0621783869832733, 0.755523107964345, -1.86502152600198))
})
